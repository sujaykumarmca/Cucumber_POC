...
public class Tags_Practice_Steps 
{
	...
	public void in_Elements_page_enter_data_for_below_forms_and_clickon_submit(DataTable arg1) throws Throwable {

	}
	
	@Before("@Element")
	@When("^In Elements page enter data for below forms$")
	public void In_Elements_page_enter_data_for_below_forms_and_clickon_submit(DataTable formdata) throws Throwable 
	{
		...
		for(Map< String, String> columns : get_data)
		{
			...
			Tags_Practice_Steps.driver.findElement(By.id("userEmail")).sendKeys(columns.get("Lastname"));
			Tags_Practice_Steps.driver.findElement(By.id("currentAddress")).sendKeys(columns.get("Lastname"));
			Tags_Practice_Steps.driver.findElement(By.id("permanentAddress")).sendKeys(columns.get("Lastname"));
	...
	{
		Tags_Practice_Steps.driver.findElement(By.id("yesRadio")).click();
	}
